rewrite to separate hg19 / hg38 integrations
...
#+begin_src snakemake
rule pon_txt:
    input:  config["data_dir"] + "/wig/{library_id}_frag{frag_distro}.wig",
    output: config["wig_dir"] + "{norm_panel_id}.
    params:
        chrs = "chr1,chr2,chr3,chr4,chr5,chr6,chr7,chr8,chr9,chr10,chr11,chr12,chr13,chr14,chr15,chr16,chr17,chr18,chr19,chr20,chr21,chr22,chrX"
    shell:
        """
...
#+begin_src bash
data_dir="/home/jeszyman/repos/cfdna-cna/test"
lib="lib001"

if [ -f ${data_dir}/wig/hg19_normals.txt ]; then \rm ${data_dir}/wig/hg19_normals.txt; fi

touch ${data_dir}/wig/hg19_normals.txt

if [ -r ${data_dir}/wig/${lib}_frag90_150.wig ]; then
    echo ${data_dir}/wig/${lib}_frag90_150.wig >> ${data_dir}/wig/hg19_normals.txt
fi

cat ${data_dir}/wig/hg19_normals.txt
#+end_src
